...
class HprModel_frame:
	...
	def initUI(self):
		...
		self.H["width"] = 5
		self.H.grid(row=5,column=0, sticky=W, padx=(115,5), pady=(10,2))
		self.H.delete(0, END)
		self.H.insert(0, "256")
		...
		self.compute.grid(row=13, column=0, padx=5, pady=(10,2), sticky=W)
	...
	def compute_model(self):
		...
		try:
			...
			hprModel_function.main(inputFile, window, M, N, H, t, minSineDur, nH, minf0, maxf0, f0et, harmDevSlope)
