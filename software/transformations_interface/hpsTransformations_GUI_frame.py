...
class HpsTransformations_frame:
    ...
    def analysis(self):
        ...
        try:
            ...
            self.inputFile, self.fs, self.hfreq, self.hmag, self.mYst, self.stocEnv_nodecimate = hT.analysis(inputFile, window, M, N, t, minSineDur, nH, minf0, maxf0, f0et, harmDevSlope, stocf)
    ...
    def transformation_synthesis(self):
        ...
        try:
            ...
            hmag = self.hmag
            mYst = self.mYst
            stocEnv_nodecimate = self.stocEnv_nodecimate
            ...
            hT.transformation_synthesis(inputFile, fs, hfreq, hmag, mYst, stocEnv_nodecimate, stocf, freqScaling, freqStretching, timbrePreservation, timeScaling)
